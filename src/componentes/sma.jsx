  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section 
        ...
        style={{ backgroundImage: "url('https://cdn.sma.de/fileadmin/_processed_/2/3/csm_sma-header-company_ef0d339093.jpg')" }}
        data-aos="fade-up"
      >
      ...
      <section className="p-12 bg-gray-50" id="nosotros" data-aos="fade-up">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-semibold">
            {language === 'es' ? 'Sobre SMA' : 'About SMA'}
          </h2>
      ...
      <section className="py-12 bg-white" id="productos">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            >
              <img
                src="https://cdn.sma.de/fileadmin/_processed_/8/a/csm_solar-wechselrichter-aus_bb8aee40ed.webp"
                alt="Inversor SMA"
              ...
              <p className="text-gray-600 mt-2">
                {language === 'es' ? 'Inversores eficientes para sistemas solares residenciales y comerciales.' : 'Efficient inverters for residential and commercial solar systems.'}
              </p>
            </div>
            {/* Producto 2 */}
            <div
            ...
            >
              <img
                src="https://cdn.sma.de/fileadmin/_processed_/e/9/csm_SMA-eCharger-new_426x426_6bee40c344.webp"
              ...
              <p className="text-gray-600 mt-2">
                {language === 'es' ? 'Soluciones avanzadas para el almacenamiento de energía solar.' : 'Advanced solutions for storing solar energy.'}
              </p>
            </div>
            {/* Producto 3 */}
            <div
            ...
            >
              <img
                src="https://cdn.sma.de/fileadmin/_processed_/4/9/csm_SMA-Home-Storage_426x426_50b47857a5.webp"
              ...
              <p className="text-gray-600 mt-2">
                {language === 'es' ? 'Cargadores solares para vehículos eléctricos, optimizando el uso de energía renovable.' : 'Solar chargers for electric vehicles, optimizing the use of renewable energy.'}
              </p>
            </div>
          </div>
        </div>
