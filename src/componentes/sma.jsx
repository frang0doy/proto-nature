...
const Sma = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Aquí va el contenido específico de Hoppecke */}
      <main className="flex-grow p-6">
        <h1 className="text-4xl font-bold text-center my-12">{language === 'es' ? 'Sma' : 'Sma'}</h1>
        {/* Agrega el contenido o los componentes que desees mostrar en esta página */}
        {/* Puedes agregar aquí las imágenes, descripciones o cualquier otra cosa relacionada con Hoppecke */}
      </main>
