  ...
  return (
    <section className="productos-section py-6">
      <div className="container mx-auto text-right px-4">
        <h2 className="text-4xl font-bold text-gray-800" data-aos="fade-up">Nuestros Productos</h2>
        <p className="mt-4 text-gray-600" data-aos="fade-up" data-aos-delay="100">Empoderar soluciones para la Transformación de la vida</p>
          ...
          >
            {products.map((product, index) => (
              <div key={index} 
                ...
                data-aos="zoom-in"
                data-aos-delay={index * 100}  // Para que las tarjetas se animen con un pequeño retraso
              >
      ...
      {showModal && selectedProduct && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-gradient-to-r from-gray-300 to-gray-600 p-6 rounded-md shadow-xl max-w-4xl w-full relative overflow-hidden">
            ...
            {/* Botón "Ver todos los productos" con efecto hover */}
            <div className="flex justify-center mt-4">
              <button
                onClick={() => alert("Ver todos los productos...")}
                className="relative text-gray-800 text-lg font-semibold py-2 px-6 rounded-md group"
              >
